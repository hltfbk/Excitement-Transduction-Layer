...
public class AdvAdjAsModifierAnnotator extends POSbasedModifierAnnotator {
	...
	/**
	 * Constructor with LAP, default negation check, adds as classes adverbs (ADV) and adjectives (ADJ)
	 * 
	...
	/**
	 * Constructor with LAP and negation check, adds as classes adverbs (ADV) and adjectives (ADJ)
	 * 
	 * @param lap -- the Linguistic Annotation Pipeline for annotation
	...
	/**
	 * Constructor with LAP and fragment annotator, default negation check, adds as classes adverbs (ADV) and adjectives (ADJ)
	 * 
	 * @param lap -- the Linguistic Annotation Pipeline for annotation
