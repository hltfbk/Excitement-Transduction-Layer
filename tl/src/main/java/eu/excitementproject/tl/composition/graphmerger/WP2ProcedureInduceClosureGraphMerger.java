 ...
 * 
 * During the WP2 procedure, transitive closure edges are induces on the flight and are not presented to the EDAs 
 * 
 * @author Lili Kotlerman
 *
 */
public class WP2ProcedureInduceClosureGraphMerger extends AbstractGraphMerger {
	
	public WP2ProcedureInduceClosureGraphMerger(CachedLAPAccess lap, EDABasic<?> eda)
