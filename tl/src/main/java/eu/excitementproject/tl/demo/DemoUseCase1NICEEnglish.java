...
public class DemoUseCase1NICEEnglish extends UseCaseOneRunnerPrototype{
	...
	public static void main(String[] argv) {
		...
		DemoUseCase1NICEEnglish useOne;
		try {
			
			useOne = new DemoUseCase1NICEEnglish(configFileName, dataDir, fileNumberLimit, outputFolder, lapClass, edaClass);
