 ...
 */
public interface GraphMerger<inputV, inputE, workV, workE> {
  ...
  reason
	 */
	public EntailmentGraphRaw<workV,workE> mergeGraphs(
		Set<FragmentGraph<inputV,inputE>> fragmentGraphs,
		EntailmentGraphRaw<workV,workE> workGraph) throws GraphMergerException;
	...
	/** input-case2: a single FragmentGraph ({@link FragmentGraph}), and a work
	  ...
	  reason
		 */
	public EntailmentGraphRaw<workV,workE> mergeGraphs(
			FragmentGraph<inputV,inputE> fragmentGraph,
			EntailmentGraphRaw<workV,workE> workGraph) throws GraphMergerException;
