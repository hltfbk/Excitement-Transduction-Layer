...
import eu.excitement.api.exceptions.CollapsedGraphGeneratorException;
import workGraph.EntailmentGraphRaw;
import finalGraph.EntailmentGraphCollapsed;
 ...
 */
public interface CollapsedGraphGenerator<workV, workE, finalV, finalE> {
  ...
  reason
	 */
	public EntailmentGraphCollapsed<finalV, finalE> generateCollapsedGraph(EntailmentGraphRaw<workV, workE> workGraph) 
