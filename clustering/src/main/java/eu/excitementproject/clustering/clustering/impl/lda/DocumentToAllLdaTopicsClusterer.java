 ...
 * 
 */
public class DocumentToAllLdaTopicsClusterer extends AbstractDocumentLdaClusterer {
	
	public DocumentToAllLdaTopicsClusterer(boolean useExpandedCollection, TextCollection textCollection, String conf, int numOfTopics, WeightType weightType) throws ClusteringException {
	...
	public DocumentToAllLdaTopicsClusterer(boolean useExpandedCollection,
