 ...
 * 
 * Implementation of the K-medoids clustering algorithm as suggested by Hui Ye and Steve Young, "A clustering approach to semantic decoding." INTERSPEECH. 2006. *
 * 
 ...
 */
public abstract class AbstractDocumentKmedoidsClusterer extends AbstractKmedoidsClusterer<VectorRepresentation> implements DocumentClusterer {

	public AbstractDocumentKmedoidsClusterer(boolean useExpandedCollection,
