 ...
 *
 */
public class DocumentsAsTermVectorsCompleteLinkClusterer extends AbstractDocumentCompleteLinkClusterer {
	...
	public DocumentsAsTermVectorsCompleteLinkClusterer(boolean useExpandedCollection, WeightType weightType) {
