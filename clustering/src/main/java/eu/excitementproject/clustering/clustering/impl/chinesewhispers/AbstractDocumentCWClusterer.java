 ...
 * 
 */
public abstract class AbstractDocumentCWClusterer extends AbstractChineseWhispersClusterer<VectorRepresentation> implements DocumentClusterer {

		
	public AbstractDocumentCWClusterer(boolean useExpandedCollection,
