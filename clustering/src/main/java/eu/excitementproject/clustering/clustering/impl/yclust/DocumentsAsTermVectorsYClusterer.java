 ...
 *
 */
public class DocumentsAsTermVectorsYClusterer extends AbstractDocumentYClusterer {
	...
	public DocumentsAsTermVectorsYClusterer(boolean useExpandedCollection, WeightType weightType, Double similarityThreshold) {
