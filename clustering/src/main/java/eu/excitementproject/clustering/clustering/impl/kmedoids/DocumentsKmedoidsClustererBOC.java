 ...
 *
 */
public class DocumentsKmedoidsClustererBOC extends AbstractDocumentKmedoidsClusterer {
	...
	public DocumentsKmedoidsClustererBOC(boolean useExpandedCollection, Map<String,List<String>> concepts, WeightType weightType, Double similarityThreshold) {
