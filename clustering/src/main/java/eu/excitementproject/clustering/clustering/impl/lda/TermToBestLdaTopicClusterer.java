...
public class TermToBestLdaTopicClusterer extends
		AbstractTermLdaClusterer {

	public TermToBestLdaTopicClusterer(TextCollection textCollection, String conf)
			throws ClusteringException {
		super(textCollection, conf);
	}
	
	public TermToBestLdaTopicClusterer(TextCollection textCollection, String conf, File modelFile) throws ClusteringException{
