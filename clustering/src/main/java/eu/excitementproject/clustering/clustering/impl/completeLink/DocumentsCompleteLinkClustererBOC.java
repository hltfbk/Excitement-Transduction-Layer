 ...
 *
 */
public class DocumentsCompleteLinkClustererBOC extends AbstractDocumentCompleteLinkClusterer {
	...
	public DocumentsCompleteLinkClustererBOC(boolean useExpandedCollection, Map<String,List<String>> concepts, WeightType weightType) {
