...
public class LegacyTermToAllLdaTopicsClustererUnsorted extends AbstractTermByRelatednessLdaClusterer {

	public LegacyTermToAllLdaTopicsClustererUnsorted(boolean useExpandedCollection,
