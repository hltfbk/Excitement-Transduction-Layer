 ...
 *
 */
public class LegacyDocumentToBestLdaTopicClustererUnsorted extends AbstractDocumentLdaClusterer {
	
	public LegacyDocumentToBestLdaTopicClustererUnsorted(boolean useExpandedCollection, TextCollection textCollection, String conf, int numOfTopics, WeightType weightType) throws ClusteringException {
	...
	public LegacyDocumentToBestLdaTopicClustererUnsorted(boolean useExpandedCollection,
